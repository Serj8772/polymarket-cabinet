...
export function Sidebar() {
  return (
    <aside className="w-60 min-h-screen bg-[var(--bg-secondary)] flex flex-col" style={{ boxShadow: '1px 0 0 var(--border-color)' }}>
      {/* Logo */}
      <div className="px-5 py-5">
        <h1 className="text-base font-semibold tracking-tight text-[var(--text-primary)]">
          Polymarket
        </h1>
        <p className="text-[11px] text-[var(--text-secondary)] mt-0.5">Personal Cabinet</p>
      </div>
